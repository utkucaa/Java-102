...
public class MobilPhone extends Product {
    ...
    Brand b1 = new Brand();
    ArrayList<MobilPhone> phone = new ArrayList<>();
    private String color;
    private int batteryPow;

    public MobilPhone(int id, String name, int price, double discount, int stock, Brand brand, int ram, int storage,
    ...
    public void addItem() {
        ...
        MobilPhone m1 = new MobilPhone(idGenerator(), name, price, discount, stock, brand , ram, storage, screenSize, color, battery);
    ...
    public void getProduct() {
        ...
        for (MobilPhone mobilPhone : phone) {
